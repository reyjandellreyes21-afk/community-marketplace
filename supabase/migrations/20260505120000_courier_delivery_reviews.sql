-- Phase 4: buyer → courier trust (per community delivery assignment, not the product order line).
-- One review row per accepted courier assignment (one completed delivery run).
